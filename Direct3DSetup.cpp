...
bool LoadShaders()
{
	...
	gSimpleVertexShader = LoadVertexShader("TransformColour_vs"); // Note how the shaders are named to show what type they are
	gSimplePixelShader = LoadPixelShader("OneColour_ps");
